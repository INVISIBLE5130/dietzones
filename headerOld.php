...
<body><noscript>
    ...
    <section class="main">
        <div class="main__header"><img class="navbar__burger" id="menu-open" src="/img/icons/burger.svg" alt="Open menu"><a class="main__logo-wrap" href="/"><img class="main__logo" src="/img/big-logo.svg" alt="DietZones.com logo"></a>
            <div class="main__header-btn-wrap"> <img class="navbar__search" src="/img/icons/search.svg" alt="search"> <a class="main-btn main-btn_accent-outline navbar__btn-signup" href="/">Sign up</a><a class="main-btn main-btn_black navbar__btn-signin" href="/">Sign in</a> </div>
        </div>
